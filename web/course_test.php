                ...
                <div class="row">
                  <table class="table">
                    ...
                    <tbody>
                      <?php 
                      $counter=1;
                      $allsubject = $course->viewall_assessment('1');
                      ...
                      <tr id="<?php echo $allsubject[$key]['id'];?>">
                        ...
                        <td>
                          <div class="dropdown">
                            <button class="btn btn-dark-outline dropdown-toggle" type="button" data-toggle="dropdown">Click To Open
                            <span class="caret"></span></button>
                              <ul class="dropdown-menu">
                              <?php $pcount='1'; $papers=$course->get_assessment_paper($allsubject[$key]['id']); 
                                if(count($papers)>0){
                                foreach($papers as $prow=>$value){ ?>  
                              <li><a href="#" onclick="show_page_model('index.php?action=nocss_pages&page=course_assessment_pdf&id=<?php echo $papers[$prow]['id'];?>&asid=<?php echo $papers[$prow]['asid'];?>')" data-toggle="modal" data-target="#myModal"><?php echo "Exam Test ".$pcount++;?></a></li>
                            <?php }} else{?>
                              <li><a href="#">No Test Found</a></li>
                            <?php }?>
                            </ul>
                          </div>
