...
<div class="">
   <div id="msgcreate_chapter_bulk"></div>
                  <form action="<?php echo $base_url.'index.php?action=course&query=create_chapter_bulk';?>" method="post" name="create_chapter_bulk" id="create_chapter_bulk" class="form-sample">
<div class="row">                      
<div class="col-sm-12">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="button" name="topic" class="btn btn-md btn-primary" value="Add More Chapters" id="topic_btn">
                        <input type="button" name="bulkupload" value="Save" class="btn btn-success btn-md" onclick="form_submit('create_chapter_bulk')">
                      </div>
