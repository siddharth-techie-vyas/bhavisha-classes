                    ...
                    <tbody>
                     ...
                     <tr>
                         ...
                         <td><?php $subcat = $accounts->get_all_transaction_type_subcat($t_type1[$row]['id']);
                                ...
                                {echo "<ul>";
                                    foreach($subcat as $k => $value)
                                    {
                                        ...
                                        <i class="fa fa-times btn btn-danger btn-sm" onclick="deleteme('accounts','delete_transaction_type','<?php echo $subcat[$k]['id'];?>')"></i>
                         ...
                         <td>
                            ...
                            <i class='fa fa-times btn btn-danger btn-sm' onclick="deleteme('accounts','delete_transaction_type','<?php echo $classes[$k]['id'];?>')"></i>
                         </td>
                     </tr>
