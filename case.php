		...
		if($_GET['action']=='lead')
 		{
 			...
 			{ 
				...
				$save = $leads->create_lead($_POST['ldate'],$_POST['uname'],$_POST['course_name'],$_POST['subject0'],$_POST['contact'],$_POST['email'],$_POST['dob'],$_POST['medium'],$_POST['reference'],$_POST['remark'],$_POST['branch'],$_POST['demo'],$education); 
			echo "<script>window.location.href='".$base_url."index.php?action=dashboard&page=lead_addnew&status=success';</script>";
 			...
 			{ 
				...
				$education = json_encode($education_array);
				$save = $leads->edit_lead($_POST['ldate'],$_POST['uname'],$_POST['course_name'],$_POST['subject0'],$_POST['contact'],$_POST['email'],$_POST['dob'],$_POST['medium'],$_POST['reference'],$_POST['remark'],$_POST['branch'],$_POST['demo'],$education,$_POST['id']); 
			}
